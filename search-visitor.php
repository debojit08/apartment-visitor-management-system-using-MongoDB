...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php
                                 ...
                                 echo"<p align='center' style='color: red'>Search result against' $sdata 'keyword </p>";
                                ?>
                                 ...
                                 <?php
                                    ...
                                    if(isset($_POST['search'])){
                                     $sdata = $_POST['searchdata'];
                                      ...
                                      foreach ($rows as $row){
                                        $id = $row->_id;
                                        if($sdata==$row->VisitorName || $sdata==$row->MobileNumber){
                                                    $flag = 1;
                                                   //echo"<p align='center' style='color: red'>Result against' $sdata 'keyword </p>";
                                                  }
    ...
    echo "</tr>";
                     ...
                     if($flag==0){
                        echo"<p align='center' style='color: red'>No record found ..!</p>";
                      }
                 echo "</table>";
