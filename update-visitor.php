...
//     'Relation'=>$relation,
//     'EnterDate'=>$date_created, //startotime(date("r")),
//     'Status'=>$status,
//     'outtime'=>''
//     ];
...
<body class="animsition">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Update</strong> Existing Visitors
                                    </div>
    ...
    echo $msg;
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <!-- <input type="text" id="relation" name="status" class="form-control" value="<?php echo $_GET['status']; ?>" required="true"> -->
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Entry DateTime</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="datetime-local" id="bdaytime1" name="bdaytime1" class="form-control" required="true">
